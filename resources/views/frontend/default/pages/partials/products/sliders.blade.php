            ...
            @foreach ($galleryImages as $galleryImage)
                <div class="swiper-slide text-center">
                    <img src="{{ uploadedAsset($galleryImage) }}" alt="{{ $product->collectLocalization('name') }}"
                        class="img-fluid" onerror="this.src='{{ staticAsset('backend/assets/img/default_image.jpeg') }}'">
                </div>
            @endforeach
        </div>
    </div>
            ...
            @foreach ($galleryImages as $galleryImage)
                <div
                    ...
                    <img src="{{ uploadedAsset($galleryImage) }}?thumb"
                        alt="{{ $product->collectLocalization('name') }}" class="img-fluid" onerror="this.src='{{ staticAsset('backend/assets/img/default_image.jpeg') }}'">
                </div>
            @endforeach

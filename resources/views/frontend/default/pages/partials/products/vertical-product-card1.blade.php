...
{{--saad--}}
    ...
    <div class="card-content">
        ...
        <a href="{{ route('products.show', $product->slug) }}"
            class="card-title fw-semibold mb-2 tt-line-clamp tt-clamp-1" style="-webkit-line-clamp: 2;text-overflow: ellipsis;">{{ $product->name }}
        </a>
            ...
            <form action="" class="direct-add-to-cart-form">
                ...
                @if (!$isVariantProduct && $stock < 1)
                    <a href="javascript:void(0);"
                        class="btn btn-outline-secondary btn-sm border-secondary d-block mt-4 w-100 button_responsive">{{ localize('Out of Stock') }}</a>
                @else
                    <a href="javascript:void(0);"
                        onclick="directAddToCartFormSubmit(this)"class="btn btn-outline-secondary btn-sm border-secondary d-block mt-4 w-100 direct-add-to-cart-btn add-to-cart-text button_responsive">{{ localize('Add to Cart') }}</a>
                @endif
            </form>
        @endif

<div class="account-nav bg-white rounded py-5">
    ...
    <ul class="nav nav-tabs border-0 d-block account-nav-menu" role="tablist">
        ...
        <li>
        <a href="{{ route('customers.refundHistory') }}"
           class="{{ areActiveRoutes(['customers.refundHistory'], 'active') }}">
                <span class="me-2">

                    <i class="fa-solid fa-arrow-rotate-left" style="font-size: 20px"></i>
                </span>
            {{ localize('Refund/Return Requests') }}
        </a>
        </li>
        <li>

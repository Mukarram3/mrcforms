...
{{--                                        @if($address->city_id == \Illuminate\Support\Facades\Session::get('city'))--}}
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="tt-address-content">
                                                    <input type="radio" class="tt-custom-radio" {{ $key == 0 ? 'checked' : '' }} name="shipping_address_id"
...
{{--                            <h4 class="mt-7 mb-3">{{ localize('Preferred Delivery Time') }}</h4>--}}
                            <div class="row g-4">
                                <div class="col-12">
                                    <div class="tt-address-content d-none">
                                ...
                                @if (getSetting('enable_scheduled_order') == 1)
                                    <div class="col-12">
                                        <div class="tt-address-content pt-2">
                                            <input type="radio" class="tt-custom-radio" name="shipping_delivery_type"

...
//                                        $product_listing_categories = getSetting('product_listing_categories') != null ? json_decode(getSetting('product_listing_categories')) : [];
                                        ...
                                        if (isset($_GET['category_id'])){
                                            $category = \App\Models\Category::where('id',$_GET['category_id'])->first();
                                            $categories = $category->relatedCategories();
                                        }else{
                                            $categories = \App\Models\Category::inRandomOrder()->limit(15)->get();
                                        }
                                    @endphp
                                    @foreach ($categories as $category)
                                        ...
                                        <li><a href="{{ route('products.index') }}?&category_id={{ $category->id }}"
                                                class="d-flex justify-content-between align-items-center">{{ $category->collectLocalization('name') }}
...
{{--                                            <div class="col-lg-4 col-md-6 col-sm-10">--}}
                            ...
                            <div style="width: 100%">
                                <ul class="d-flex align-items-center gap-3 mt-7" style="width: 100%">

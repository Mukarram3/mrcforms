...
<footer class="gshop-footer      position-relative   z-1 overflow-hidden">
...
{{--        class="position-absolute tomato-half z--1 vector-shape">--}}
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6">
                <div class="gshop_subscribe_form text-center">
                    <h4 class="text-dark gshop-title">{{ localize('Please subscribe for ') }}<mark
                            ...
                            class="d-none d-sm-block">{{ localize('and Other Important Information.') }}</h4>
                    <form class="mt-5 d-flex align-items-center  subscribe_form"
                        action="{{ route('subscribe.store') }}" method="POST">
                        @csrf
                        <input type="email" class="form-control border border-dark" placeholder="{{ localize('Enter Email Address') }}"
        ...
        <span class="gradient-spacer  my-4 d-block"></span>
...
{{--                        <li class="text-white pb-2 fs-xs">{{ getSetting('topbar_email') }}</li>--}}
                        ...
                        <li class="text-white pb-2 fs-xs">
...
{{--                                   aria-haspopup="true" aria-expanded="false">{{ $branch? $branch->name : '' }}</a>--}}
    ...
    <div class="footer-copyright bg-dark pt-120 pb-3">

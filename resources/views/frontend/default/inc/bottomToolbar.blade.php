...
{{--        Home--}}
        ...
        <a class="d-table-cell mobile-toolbar-item" href="{{ route('home') }}">
...
{{--                </svg>--}}
                <svg width="18" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path opacity="0.5" d="M2.36407 12.9579C1.98463 10.3208 1.79491 9.00229 2.33537 7.87495C2.87583 6.7476 4.02619 6.06234 6.32691 4.69181L7.71175 3.86687C9.80104 2.62229 10.8457 2 12 2C13.1543 2 14.199 2.62229 16.2882 3.86687L17.6731 4.69181C19.9738 6.06234 21.1242 6.7476 21.6646 7.87495C22.2051 9.00229 22.0154 10.3208 21.6359 12.9579L21.3572 14.8952C20.8697 18.2827 20.626 19.9764 19.451 20.9882C18.2759 22 16.5526 22 13.1061 22H10.8939C7.44737 22 5.72409 22 4.54903 20.9882C3.37396 19.9764 3.13025 18.2827 2.64284 14.8952L2.36407 12.9579Z" fill="#5D6374" stroke="#5D6374" stroke-width="0.2"/>
                        <path d="M9 16C9.85038 16.6303 10.8846 17 12 17C13.1154 17 14.1496 16.6303 15 16" fill="#5D6374" stroke="#1C274C" stroke-width="0.2" stroke-linecap="round"/
                    </g>

                </svg>
            </span>
            <span class="mobile-toolbar-label">{{ localize('Home') }}</span>
        </a>
{{--        End Home--}}
        <a class="d-table-cell mobile-toolbar-item " href="{{ url('categories') }}">
...
{{--        <div class="gshop-header-search dropdown d-table-cell mobile-toolbar-item">--}}
        {{-- !------End Comment Area------! --}}
{{--            <button class="header-icon" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"  aria-controls="offcanvasTop">--}}
...
{{-- !------Search offcanvas search button on header.blade.php------! --}}
            <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" data-bs-backdrop="false" aria-labelledby="offcanvasTopLabel" style="height: 75px;">
                {{-- !------Start Comment Area------! --}}
...
{{--                </div>--}}
                ...
                <div class="offcanvas-body">
                    <form class="search-form d-flex align-items-center" id="bottomserahcform" action="{{ route('products.index') }}">
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close" id="close_btn"></button>

                        <input type="text" placeholder="{{ localize('Search products') }}..." class="w-100 dropup"
                               name="search" id="bottom-search" @isset($searchKey) value="{{ $searchKey }}" @endisset>
...
{{--<div class="offcanvas-left-menu position-fixed d-lg-none d-md-none ">--}}

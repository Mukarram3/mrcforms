                             ...
                             <div class="row g-4">
                                 <div class="col-sm-6">
                                     <div class="w-100 label-input-field">
                                         ...
                                         <input type="text" placeholder="{{ localize('Enter Full Name') }}" name="full_name" required />
                                 ...
                                 <div class="col-sm-6">
                                     <div class="w-100 label-input-field">
                                         ...
                                         <input type="text" placeholder="{{ localize('Enter Phone Number') }}" name="phone" required />

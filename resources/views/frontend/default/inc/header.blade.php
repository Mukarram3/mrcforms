@php
    //$getNaveColor = \App\Models\NavigationColor::orderBy('id','desc')->first();
    $getNaveColor = \App\Models\NavigationColor::first();
//    $categories = \Illuminate\Support\Facades\DB::table('categories')->get();
//    $categories = \App\Models\Category::whereNull('parent_id')->orWhere('parent_id',0)->with('children.children')->get();
@endphp
<style>
    /*.rounded-radius {*/
    /*    border-radius: 25px; !* Adjust the border-radius to make it more or less rounded *!*/
    ...
    /*.rounded-radius:hover{*/
    /*    box-shadow: 0 8px 12px rgba(0, 0, 0, 0.2); !* Adjust the shadow on hover *!*/
    /*}*/

</style>
<header class="gheader position-relative z-2 header-sticky">
    <div class="ghead-topbar d-none d-lg-block" style="background-color: {{ $getNaveColor->background_color }}">
        <div class="container">
...
{{--                                <span class="me-1">--}}
{{--                                    <svg width="16" height="14" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item dropdown tt-language-dropdown">
                            ...
                            @if (\Illuminate\Support\Facades\Session::has('city'))
                                ...
                                <a href="" class="dropdown-toggle text-capitalize " data-bs-toggle="modal" onclick="showModal()"
                                   aria-expanded="false">{{ $city ? $city->name : '' }}</a>
                            @else
...
//                                $branch = \App\Models\Branch::withWhereHas('cities',fn ($query)=> $query->where('city_id',$cityid))->get()->last();
                                @endphp

                                <a href="#" class="dropdown-toggle text-capitalize " data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">{{ $branch? $branch->name : '' }}</a>
...
{{--                            </ul>--}}
{{--                        </li>--}}
                        {{--END CURRENCY COMMENT--}}
                        <li class="nav-item d-sm-none d-none d-md-block d-lg-block">
    ...
    <div class="container">
        <div class="gshop-navbar bg-white rounded ps-lg-5 position-relative">
            <div class="row align-items-center">
                ...
                <div class="col-xxl-2 col-xl-3 col-md-2 col-2 text-center d-lg-none d-xl-none">
                ...
                <div class="col-xxl-10 col-xl-9 col-md-7 col-5">
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        ...
                        <div class="category-dropdown position-relative d-none d-md-inline-block">
                            ...
                            <a href="{{ url('categories') }}"
                                class="category-dropdown-btn fw-bold d-none d-sm-inline-block d-lg-none">{{ localize('Categories') }}
                            </a>


{{--                            <div class="category-dropdown-box scrollbar">--}}
{{--                                <ul class="category-dropdown-menu" style="height: 100vh;overflow: scroll">--}}
{{--                                    @php--}}
{{--                                        $categories = [];--}}
...
{{--                                                         onerror="this.src='{{ staticAsset('backend/assets/img/default_image.jpeg') }}'" alt="" class="rounded-circle h-100 w-100">--}}
{{--                                                </div>--}}
...
{{--                                    @foreach ($categories as $navbarCat)--}}
{{--                                        <li>--}}
{{--                                            <a href="{{ url('/products?&category_id='.$navbarCat->id) }}"--}}
{{--                                               class="d-flex align-items-center">--}}
{{--                                                <p>{{ $navbarCat->name }}</p>--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
...
{{--                                    <a href="javascript:void(0);">{{ localize('Categories') }}<span--}}
...
{{--                                                        @foreach($category->children as $subcategory)--}}
{{--                                                            <li class="has-submenu">--}}
{{--                                                                <a href="javascript:void(0);">{{ $subcategory->name }}<span class="ms-1 fs-xs float-end"><i class="fa-solid fa-angle-down"></i></span></a>--}}
{{--                                                                @if($subcategory->children->isNotEmpty())--}}
{{--                                                                    <ul class="submenu">--}}
{{--                                                                        @foreach($subcategory->children as $subSubcategory)--}}
{{--                                                                            <li><a href="{{ $subSubcategory->url }}">{{ $subSubcategory->name }}</a></li>--}}
{{--                                                                            <!-- You can add more nested levels here if needed -->--}}
{{--                                                                        @endforeach--}}
{{--                                                                    </ul>--}}
{{--                                                                @endif--}}
{{--                                                            </li>--}}
...
{{--                                </li>--}}
                        ...
                        <div
                            ...
                            <div class="gshop-header-search dropdown search-btn" >
                                ...
                                <div class="dropdown-menu dropdown-menu-end border-0 dropdown-search" >
                                    <form class="search-form d-flex align-items-center"
                                        action="{{ route('products.index') }}" id="searchform">
                                        <div>
                                            <input type="text" placeholder="{{ localize('Search products') }}"
                                                   class="w-100 autocomplete" name="search" id="autocomplete"
                                                   @isset($searchKey)
                                                       value="{{ $searchKey }}"
                                                    @endisset>
                                        </div>
                        ...
                        <button class="gshop-offcanvas-btn offcanvas-toggle ms-3 d-none d-md-block">
...
{{--DARK MODE--}}
                        <a href="javascript:void(0)" class="btn btn-link p-0 tt-theme-toggle1 fw-normal d-sm-block d-md-none d-lg-none d-xl-none d-xxl-none">
                            <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left"
                                 data-bs-title="Dark"> <i class="fas fa-moon fs-lg ms-1"></i>
                            </div>
                            <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left"
                                 data-bs-title="Light"><i class="fas fa-sun fs-lg ms-1"></i>
                            </div>
                        </a>
                        {{--//DARK MODE--}}

                        <button class="header-icon ms-3  d-sm-block d-md-none d-lg-none d-xl-none d-xxl-none rounded-radius" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"  aria-controls="offcanvasTop">
...
{{--                <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Confirm Location</button>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}

                ...
                <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                    <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100" action="{{ route('login') }}" method="POST">
                        ...
                        <h2 class="mb-4 h3">{{ localize('Hey there!') }}
                            <br>{{ localize('Welcome back to mrcfarms') }}
                        </h2>
                        ...
                        <p class="mb-0 fs-xs mt-4">{{ localize("Don't have an Account?") }}
                            <a href="{{ route('register') }}">{{ localize('Sign Up') }}</a> Or
                            <a href="{{ route('login.guest') }}">{{ localize('Login as Guest') }}</a>
                        </p>
                    </form>
                </div>
            </div>

                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.001" value="{{ $logisticZone->cost_per_kg }}" name="cost_per_kg"
                                           id=""
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" value="{{ $logisticZone->additional_cost }}" step="0.001" name="additional_cost"
                                           id=""

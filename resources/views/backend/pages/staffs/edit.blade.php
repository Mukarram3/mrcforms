                    ...
                    <form action="{{ route('admin.staffs.update') }}" method="POST" class="pb-650">
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label for="password" class="form-label">{{ localize('Select Branch') }}</label>

                                    <div class="form-check">
                                        <input class="form-check-input" {{ $user->branch_id == 0 ? 'checked' : '' }} value="{{$user->branch_id}}" type="radio" name="branch_id" id="all">
                                    ...
                                    @foreach(\App\Models\Branch::all() as $branch)
                                        <div class="form-check">
                                            <input class="form-check-input" {{ $user->branch_id == $branch->id ? 'checked' : '' }} value="{{ $branch->id }}" type="radio" name="branch_id" id="{{ "branch".$branch->id }}">

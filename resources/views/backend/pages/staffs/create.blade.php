                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" value="0" type="radio" name="branch_id" id="all">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" value="{{ $branch->id }}" type="radio" name="branch_id" id="{{ "branch".$branch->id }}">

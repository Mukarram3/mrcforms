...
{{--                                </div>--}}
                                ...
                                <div class="col-lg-6">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <h5 class="mb-4">{{ localize('Enter Weight in Grams') }}</h5>
                                            <div class="tt-select-brand">
                                                <input class="form-control" type="number" value="{{ $product->weight }}"  id="weight"
                                                       placeholder="{{ localize('Enter Weight in Grams') }}" name="weight" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                    </div>--}}
                                    ...
                                    @foreach($branches as $key=>$branch)
                                        ...
                                        <?php
                                            $productPrice = \App\Models\ProductPrice::where('branch_id',$branch->id)->where('product_id',$product->id)->first(); ?>
                                        <div class="noVariation">
                                            <div class="row g-3">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <input type="hidden" value="{{  $productPrice ? $productPrice->id : '' }}" name="dt[{{$key}}][product_price_id]">
                                                        <label for="branch" class="form-label">{{ localize('Branch') }}</label>
                                                        <input type="text" value="{{ $branch->name }}"
                                                               name="dt[{{$key}}][branch_name]" placeholder="{{ localize('Branch') }}"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" min="0" value="{{ $productPrice ? $productPrice->max_price : '' }}" step="0.0001" id="price"
                                                               name="dt[{{$key}}][price]" placeholder="{{ localize('Product price') }}"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="stock" value="{{ $productPrice ? $productPrice->stock_qty : '' }}"
                                                               placeholder="{{ localize('Stock qty') }}" name="dt[{{$key}}][stock]"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label for="sku" class="form-label">{{ localize('Bar Code') }}</label>
                                                        <input type="text" id="Bar Code" value="{{ $productPrice ?  $productPrice->bar_code : '' }}"
                                                               placeholder="{{ localize('Product Bar Code') }}" name="dt[{{$key}}][bar_code]"
                                                               class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>

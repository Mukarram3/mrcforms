                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            ...
                            <tbody>
                            @foreach ($productsPaginated as $key => $product)
                                <tr>
                                    <td class="text-center">
{{--                                        {{ $key + 1 + ($productsPaginated->currentPage() - 1) * $productsPaginated->perPage() }}</td>--}}
                                    <td>
...
{{--                                {{ $productsPaginated->firstItem() }}-{{ $productsPaginated->lastItem() }} {{ localize('of') }}--}}
{{--                                {{ $productsPaginated->total() }} {{ localize('results') }}</span>--}}
{{--                            <nav>--}}
{{--                                {{ $productsPaginated->appends(request()->input())->links() }}--}}
{{--                            </nav>--}}
{{--                        </div>--}}
                        <!--pagination end-->
                    </div>

            ...
            <div class="collapse {{ areActiveRoutes($productsActiveRoutes, 'show') }}" id="sidebarProducts">
                <ul class="side-nav-second-level">
                    ...
                    @can('products')
                        ...
                        <li class="{{ areActiveRoutes(['admin.products.index.noimage'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.products.index.noimage') }}"
                               class="{{ areActiveRoutes(['admin.products.index.noimage']) }}">{{ localize('Product With No Image') }}</a>
                        </li>

                        <li class="{{ areActiveRoutes(['admin.products.index.image'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.products.index.image') }}"
                               class="{{ areActiveRoutes(['admin.products.index.image']) }}">{{ localize('Product Image') }}</a>
                        </li>
                    @endcan
                    ...
                    @endcan
                        ...
                        @can('review')
                            <li class="{{ areActiveRoutes(['admin.product.review'], 'tt-menu-item-active') }}">
                                <a href="{{ route('admin.product.review') }}"
                                   class="{{ areActiveRoutes(['admin.product.review']) }}">{{ localize('Reviews') }}</a>
                            </li>
                        @endcan
                </ul>
            </div>
...
{{--    @endcan--}}
    ...
    @can('orders')
        @if(\Illuminate\Support\Facades\Auth::user()->user_type == "admin")
            <li class="side-nav-item nav-item {{ areActiveRoutes(['admin.orders.index', 'admin.orders.show'], 'tt-menu-item-active') }}">
            ...
            <li class="side-nav-item nav-item {{ areActiveRoutes(['admin.refund.index'], 'tt-menu-item-active') }}">
                <a href="{{ route('admin.refund.index') }}"
                   class="side-nav-link {{ areActiveRoutes(['admin.refund.index']) }}">
                    <span class="tt-nav-link-icon"><i data-feather="shopping-cart"></i></span>
                    <span class="tt-nav-link-text">
                    <span>{{ localize('Refund/Return Order') }}</span>

                    @php
                        $newRequestCount = \App\Models\RefundRequest::IsAdminApproval()->count();
                    @endphp
        ...
        @else
            ...
            @endcan
            <li class="side-nav-item nav-item order-branch">
                <a data-bs-toggle="collapse" href="#orderBranch"
                ...
                <div class="collapse order-branch" id="orderBranch">
                    <ul class="side-nav-second-level">
                        @foreach(\App\Models\Branch::all() as $branch)
                            @if(\Illuminate\Support\Facades\Auth::user()->branch_id == $branch->id)
                                <li class="">
                                    <a href="{{ route('admin.branch.orders',$branch->id) }}">{{ $branch->name }}
                                    </a>
                                </li>
...
{{--    COMMENT STOCK--}}
    @php
        $stockActiveRoutes = ['admin.branch.orders','admin.stocks.create', 'admin.locations.index', 'admin.locations.create', 'admin.locations.edit'];
    @endphp
...
{{--        </li>--}}
        ...
        <li class="side-nav-item nav-item {{ areActiveRoutes($stockActiveRoutes, 'tt-menu-item-active') }}">
            <a data-bs-toggle="collapse" href="#manageBranch"
               aria-expanded="{{ areActiveRoutes($stockActiveRoutes, 'true') }}" aria-controls="manageStock"
               class="side-nav-link tt-menu-toggle">
                <span class="tt-nav-link-icon"><i data-feather="database"></i></span>
                <span class="tt-nav-link-text">{{ localize('Branch') }}</span>
            </a>
            <div class="collapse {{ areActiveRoutes($stockActiveRoutes, 'show') }}" id="manageBranch">
                <ul class="side-nav-second-level">
                        <li class="{{ areActiveRoutes(['admin.branch.index', 'admin.branch.create', 'admin.branch.edit'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.branch.index') }}">{{ localize('All Branches') }}</a>
                        </li>
                    <li class="{{ areActiveRoutes(['admin.branch.index', 'admin.branch.create', 'admin.branch.edit','admin.branch.import.export'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.branch.import.export') }}">{{ localize('Export & Import') }}</a>
                        </li>
    ...
    @can('campaigns')
        <li
            ...
            <a href="{{ route('admin.campaigns.index') }}" class="side-nav-link">
                ...
                <span class="tt-nav-link-text">{{ localize('Offers') }}</span>
            </a>
        </li>
    @endcan
...
{{--                    END COMMENT BY*s*--}}
                        ...
                        <li
                            ...
                            <a href="{{ route('backup.index') }}"
                               class="{{ areActiveRoutes(['backup.index']) }}">{{ localize('BackUp Tab') }}</a>
                        </li>
                </ul>
            </div>
        </li>

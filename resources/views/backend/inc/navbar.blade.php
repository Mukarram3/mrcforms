            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                @if (Route::is('admin.pos.index'))
                    <div class="align-items-center d-none d-lg-flex">
                        ...
                        <div class="tt-brand pe-3">
                            <a href="{{ route('admin.dashboard') }}">
{{--                                <img src="{{ uploadedAsset(getSetting('admin_panel_logo')) }}" class="tt-brand-favicon"--}}
{{--                                    alt="favicon" />--}}

                                <img src="{{ uploadedAsset(getSetting('admin_panel_logo')) }}" class="tt-brand-logo pos-logo" alt="logo" />
                            </a>
                        </div>
                    </div>
                @endif

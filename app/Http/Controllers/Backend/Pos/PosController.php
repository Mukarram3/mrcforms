...
//            $product_variation = $prd->variations[0];
...
//        $productVariationStock = $productVariation->product_variation_stock; // if null, out of stock for this location
        $productVariationStock = 5; // if null, out of stock for this location
...
//            $stock = $productVariationStock->stock_qty;
    ...
    public function downloadInvoice($id)
    {
        ...
        return PDF::loadView('backend.pages.orders.invoice', $pdfOptions)

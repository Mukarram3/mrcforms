...
use App\Exports\SaleAmountExport;
...
class ReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = $products->paginate(paginationNumber(30), ['id','name', 'thumbnail_image', 'slug', 'total_sale_count']);
    ...
    public function downloadReport(){
        return Excel::download(new OrderExport(), 'order1.csv');
    }


    public function downloadProductReport(){
        return Excel::download(new ProductExport(), 'product1.csv');
    }

    public function downloadCategoryReport(){
        return Excel::download(new CategoryExport(), 'category1.csv');
    }

    public function downloadAmountReport(){
        return Excel::download(new SaleAmountExport(), 'SaleAmount.csv');
    }

    public function downloadDeliveryReport(){

        return Excel::download(new DeliveryStatusReportExport(), 'DeliveryStatus.csv');
    }
}

...
class CustomerController extends Controller
{
    ...
    {
        $orders = RefundRequest::with('order','refundItems.orderItem.product_variation.product')->where('user_id',Auth::user()->id)->latest()->paginate(paginationNumber());

//        dd($orders->refundItems->orderItem->product_variation->product);
        return getView('pages.users.refundrequest', ['orders' => $orders]);
    }

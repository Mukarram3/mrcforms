...
Route::get('/product-export', [HomeController::class, 'productExport']);
...
Route::get('/get-reviews', [HomeController::class, 'getReview']);

Route::get('/product-with-noImages', [\App\Http\Controllers\Backend\Products\ProductsController::class, 'productNoImage']);
...
Route::controller(LoginController::class)->group(function () {
    ...
    Route::get('/login-as-guest', 'loginAsGuest')->name('login.guest');
});
...
Route::post('/change-city', [HomeController::class, 'changeCity'])->name('change.city');
...
Route::post('/post-product-review', [ProductController::class, 'productReview'])->name('product.review');
Route::get('/get-product-review', [ProductController::class, 'getProductReview'])->name('get.product.review');


Route::post('/refund-order', [\App\Http\Controllers\Backend\Orders\OrdersController::class, 'refundOrder'])->name('post.refund.request');
...
# campaigns
Route::get('/offers', [HomeController::class, 'campaignIndex'])->name('home.campaigns');
...
Route::group(['prefix' => '', 'middleware' => ['customer', 'verified', 'isBanned']], function () {
    ...
    Route::get('/customer-refund-requests', [CustomerController::class, 'refundHistory'])->name('customers.refundHistory');
    ...
    Route::get('/hbl', [\App\Http\Controllers\HblPayController::class, 'view']);
...
Route::group(['prefix' => ''], function () {
    ...
    Route::get('/hbl/success', [CheckoutController::class, 'hblSuccess'])->name('hbl.success');

    Route::get('/hbl/fail', [CheckoutController::class, 'hblFail'])->name('hbl.fail');

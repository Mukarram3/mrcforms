...
//Route::get('/backup', [LocationsController::class, 'backup']);
...
Route::group(['prefix' => 'backend'], function () {
    ...
    Route::get('/backup-download', [LocationsController::class, 'backupDownload'])->name('backup.download');
    Route::get('/backup', [LocationsController::class, 'backup'])->name('backup.index');
});
...
Route::group(
    ...
    function () {
        # dashboard
        Route::get('/getBranchName', [BranchController::class, 'getBranch']);
...
//        Navigation color
        Route::post('/nav/color', [\App\Http\Controllers\NavigationColor::class, 'navigationColor'])->name('admin.nav.color');
       // Route::get('/nav/color', [\App\Http\Controllers\NavigationColor::class, 'getColor']);
        ...
        Route::group(['prefix' => 'products'], function () {
            ...
            Route::get('/reviews', [ProductsController::class, 'productReview'])->name('admin.product.review');
            Route::post('/update-reviews', [ProductsController::class, 'updateReviewPublishedStatus'])->name('admin.review.updatePublishedStatus');

            Route::get('/delete-by-ids', [ProductsController::class, 'deleteById'])->name('admin.products.delete.ids');


            Route::get('/no-image', [ProductsController::class, 'noImage'])->name('admin.products.index.noimage');

            Route::get('/product-image', [ProductsController::class, 'productImage'])->name('admin.products.index.image');
            Route::post('/save-product-image', [ProductsController::class, 'storeImage'])->name('admin.products.index.store.image');
...
//        Route::get('/pos', [PosController::class, 'index'])->name('admin.pos.index');
        ...
        Route::get('/direct-create', [OrdersController::class, 'directCreate'])->name('admin.order.direct.create');
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::get('/order-branch/{id}', [OrdersController::class, 'branchOrder'])->name('admin.branch.orders');
        });

        Route::get('/refund-request', [\App\Http\Controllers\RefundController::class, 'index'])->name('admin.refund.index');
        Route::get('/refund-status/{id}', [\App\Http\Controllers\RefundController::class, 'statusUpdate'])->name('refund.status');
        ...
        Route::group(['prefix' => 'branch'], function () {
            Route::get('/', [\App\Http\Controllers\BranchController::class, 'index'])->name('admin.branch.index');
            Route::get('/add-branch', [\App\Http\Controllers\BranchController::class, 'create'])->name('admin.branch.create');
            Route::post('/add-branch', [\App\Http\Controllers\BranchController::class, 'store'])->name('admin.branch.store');
            Route::get('/edit-location/{id}', [\App\Http\Controllers\BranchController::class, 'edit'])->name('admin.branch.edit');
            Route::post('/update-location', [\App\Http\Controllers\BranchController::class, 'update'])->name('admin.branch.update');
            Route::post('/update-published-branch', [BranchController::class, 'updatePublishedStatus'])->name('admin.branch.updatePublishedStatus');

            Route::get('/import-export', [\App\Http\Controllers\BranchController::class, 'importExport'])->name('admin.branch.import.export');
            Route::post('/import', [\App\Http\Controllers\BranchController::class, 'import'])->name('admin.product.import');
            Route::post('/export', [\App\Http\Controllers\BranchController::class, 'export'])->name('admin.product.export');


            Route::post('/import-product', [\App\Http\Controllers\BranchController::class, 'productImport'])->name('admin.product.excel.import');
            Route::post('/export-order', [\App\Http\Controllers\BranchController::class, 'exportData'])->name('admin.branch.order.export');
//address
            Route::post('/update-address', [\App\Http\Controllers\BranchController::class, 'updateAddress'])->name('admin.update.address');

            Route::post('/product-branch-wise', [\App\Http\Controllers\BranchController::class, 'productExportBranch'])->name('admin.branch.product.export');
//            Customer Import
            Route::post('/customer-import', [\App\Http\Controllers\BranchController::class, 'CustomerImport'])->name('admin.customer.import');
        ...
        Route::group(['prefix' => 'logistics'], function () {
            ...
            //// Order invoice routs for update

            Route::post('/all-product', [LogisticZonesController::class, 'getAllProducts'])->name('admin.get.allproduct');
            Route::post('/order-update', [LogisticZonesController::class, 'orderUpdate'])->name('admin.update.order');


            Route::post('/order-product-update', [LogisticZonesController::class, 'orderProductUpdate'])->name('admin.order.product.update');
            Route::post('/order-subtotal-update', [LogisticZonesController::class, 'orderSubTotalUpdate'])->name('admin.order.subtotal.update');
            Route::post('/order-shipping-update', [LogisticZonesController::class, 'orderShippingUpdate'])->name('admin.order.shipping.update');
            Route::post('/order-Grand-Total-update', [LogisticZonesController::class, 'orderGrandTotalUpdate'])->name('admin.order.grandtotal.update');
            Route::post('/order-Payment-Method-update', [LogisticZonesController::class, 'orderPaymentMethodUpdate'])->name('admin.order.paymentmethod.update');
            Route::post('/order-Logistic-update', [LogisticZonesController::class, 'orderPLogisticUpdate'])->name('admin.order.logistic.update');
            Route::get('/delete/invoice/produt/{id}', [LogisticZonesController::class, 'deleteInvoiceProduct']);


            /// end order invoice updates
        ...
        Route::get('report/download', [ReportsController::class, 'downloadReport'])->name('admin.order.reports.download');
        //procuts report download
        Route::get('report/product/download', [ReportsController::class, 'downloadProductReport'])->name('admin.product.report.download');
        //category export
        Route::get('report/category/download', [ReportsController::class, 'downloadCategoryReport'])->name('admin.category.report.download');
        Route::get('report/sale-amount/download', [ReportsController::class, 'downloadAmountReport'])->name('admin.amount.report');
        Route::get('report/delivery-status/download', [ReportsController::class, 'downloadDeliveryReport'])->name('admin.reports.delivery.status');
        ...
        Route::group(['prefix' => 'appearance'], function () {
            ...
            //home - Slider Two
            Route::post('/homepage/slider/two', [HeroController::class, 'storeSecondSlider'])->name('admin.appearance.homepage.storeSliderTwo');
//            Slider Three
            Route::post('/homepage/slider/three', [HeroController::class, 'storeThirdSlider'])->name('admin.appearance.homepage.storeSliderThree');
            ...
            Route::post('/homepage/store', [TopTrendingProductsController::class, 'store'])->name('admin.trending.store');
...
//Navigation route
        //Route::get('/', [\App\Http\Controllers\NavigationColor::class, 'color'])->name('home.navigation.color');

    }


);
Route::get('/sendmail', [\App\Http\Controllers\Frontend\CheckoutController::class, 'success']);
